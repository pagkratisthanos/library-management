...
public class AuthorServiceImpl implements IAuthorService {
    ...
    public Author saveAuthor(AuthorInsertDTO authorInsertDTO)
        ...
        try {
            ...
            author.setFirstname(authorInsertDTO.firstname());
            author.setLastname(authorInsertDTO.lastname());
            author.setBio(authorInsertDTO.bio());
            author.setBirthDate(authorInsertDTO.birthDate());
            author.setBirthPlace(authorInsertDTO.birthPlace());
    ...
    public Author updateAuthor(UUID id, AuthorUpdateDTO authorUpdateDTO)
    ...
    public Author getAuthorByUuid(UUID uuid) throws EntityNotFoundException {
        try {
            Author author = authorRepository.findById(uuid)
                    .orElseThrow(() -> new EntityNotFoundException("Author", "Author with uuid= " + uuid + " not found."));
    ...
    @Override
    @Transactional(readOnly = true)
    public Author getAuthorByUUIDDeletedFalse(UUID uuid) throws EntityNotFoundException {
        try {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<Author> getAuthorsByBookUuid(UUID bookUuid) throws EntityNotFoundException {
        try {
